...
export type WebhookEventWhereInput = {
  ...
  transactionId?: Prisma.StringFilter<"WebhookEvent"> | string
...
export type WebhookEventScalarWhereWithAggregatesInput = {
  ...
  transactionId?: Prisma.StringWithAggregatesFilter<"WebhookEvent"> | string
...
export type WebhookEventOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"transactionId" | "processedAt", ExtArgs["result"]["webhookEvent"]>
...
export interface WebhookEventDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const webhookEventWithTransactionIdOnly = await prisma.webhookEvent.findMany({ select: { transactionId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many WebhookEvents and only return the `transactionId`
   * const webhookEventWithTransactionIdOnly = await prisma.webhookEvent.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more WebhookEvents and only return the `transactionId`
   * const webhookEventWithTransactionIdOnly = await prisma.webhookEvent.updateManyAndReturn({
   *   select: { transactionId: true },
   *   where: {
   *     // ... provide filter here
   *   },
